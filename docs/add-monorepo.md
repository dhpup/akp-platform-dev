...
add [akp-monorepo-dev](https://github.com/example-org/akp-monorepo-dev): application
...
1. **Fork [akp-monorepo-dev](https://github.com/example-org/akp-monorepo-dev)** (keep
...
2. **Trigger a first release**: change anything under `apps/rollouts-app/`,
   ...
   `ghcr.io/<you>/akp-monorepo-dev-rollouts-app:<run#>-<color>`.
...
4. **Point a pipeline at it.** Easiest: copy an existing app dir (e.g.
   ...
   - image:
       repoURL: ghcr.io/<you>/akp-monorepo-dev-rollouts-app
   ...
   - name: image
     value: ghcr.io/<you>/akp-monorepo-dev-rollouts-app
   ```
